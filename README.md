...
This is a native module for Nextcloud on ApisCP. Native modules are shipped with ApisCP
...
git clone https://github.com/apisnetworks/apiscp-webapp-nextcloud config/custom/webapps/nextcloud
